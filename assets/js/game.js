...
var endGame = function() {
    window.alert("The game has now ended. Let's see how you did! Meow!")
    //check localStorage for high score, if it's no tthere, use 0
    var highScore = localStorage.getItem("highscore") || 0;
    //if player has more money than high score then player has new high score
